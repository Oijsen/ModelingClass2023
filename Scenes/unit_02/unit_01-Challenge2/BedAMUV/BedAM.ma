...
//Name: BedAM.ma
//Last modified: Sat, Nov 04, 2023 12:50:53 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "17F292F9-4B3F-27DE-8C0A-C0B7EC2081E8";
createNode transform -s -n "persp";
	rename -uid "B65C3680-40A1-70C9-E615-3DB08C71B356";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -31.246037690318094 8.7143830120894652 11.003466847534106 ;
	setAttr ".r" -type "double3" -14.738352756712846 4249.4000000007682 4.7876683573803328e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 34.253928611038369;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F5836D06-4251-53ED-96F8-4B9223677CB4";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0872DC8F-42E5-29E4-FBB6-919FC45A5FE8";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3D54795C-4511-E1C7-7945-F3A6E8E37119";
createNode displayLayerManager -n "layerManager";
	rename -uid "2351968C-4008-9A8A-6CB5-7E907F124030";
createNode displayLayer -n "defaultLayer";
	rename -uid "ABD3033A-4F1A-1641-C6CE-C9A9AEF8BB18";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "FA413CBD-4C5D-2A8F-663D-1284D0B91CB9";
