...
//Name: BedAM.ma
//Last modified: Fri, Sep 08, 2023 08:08:49 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "63190ED5-47CF-14B6-340B-42BCB3FEB581";
createNode transform -s -n "persp";
	rename -uid "B65C3680-40A1-70C9-E615-3DB08C71B356";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 39.248572658181772 8.5864057695795086 0.68508638398653843 ;
	setAttr ".r" -type "double3" -12.338352735230274 3329.0000000001919 -9.1120805990382991e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 40.182659980371525;
...
createNode mesh -n "pCube8Shape" -p "pCube8";
	...
	setAttr -s 178 ".uvst[0].uvsp[0:177]" -type "float2" 0.375 0 0.625 0 0.375
		 ...
		 0.25 0.125 0.25 0.625 0 0.875 0 0.875 0.25 0.125 0 0.375 0 0.125 0.25 0.375 0 0.625
		 ...
		 0.125 0 0.375 0 0.125 0.25 0.375 0 0.625 0 0.625 0.25 0.375 0.25 0.375 0.25 0.625
		 ...
		 0.125 0.25 0.875 0 0.875 0 0.625 0 0.875 0.25 0.875 0.25 0.625 0.25 0.125 0 0.375
		 0 0.125 0 0.375 0.25 0.125 0.25 0.125 0.25 0.875 0 0.625 0 0.875 0.25 0.625 0.25
		 0.375 0 0.125 0 0.375 0.25 0.125 0.25 0.375 0 0.625 0 0.625 0.25 0.375 0.25 0.375
		 ...
		 0.25 0.375 0 0.625 0 0.625 0 0.375 0 0.625 0.75 0.625 0.75 0.375 0.75 0.375 0.75
		 0.625 0.75 0.375 0.75 0.625 1 0.375 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "25671E3D-4545-DBA5-C49F-D284A4E5E03A";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "605B50CA-4778-D8EC-E680-1CA022539879";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "4C7D6BFB-407E-C75C-F947-8BBBEF21DA94";
createNode displayLayerManager -n "layerManager";
	rename -uid "5AC4150D-448A-0118-831F-5BA9D7384ACA";
createNode displayLayer -n "defaultLayer";
	rename -uid "ABD3033A-4F1A-1641-C6CE-C9A9AEF8BB18";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "583DE827-4760-B94A-DAD3-F79106C4E1C2";
